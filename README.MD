...
TELEGRAM_BOT_TOKEN=1234567890:AbCdefGhIjKlMnOpQrStNvWxYz
```
...
> **Note for Telegram:** Create a bot via [@BotFather](https://t.me/BotFather) and get the token. The Chat ID is entered in the UI.
